...
public class JavaSource_Calendar implements Serializable {
	 ...
	 *            int
	 */
	public JavaSource_Calendar(int year, int month, int day) {
	...
	public String getGregorianDate() {
		...
		return (gYear + "-" + StandardDigits(gMonth) + "-" + StandardDigits(gDay));
	}
	...
	private String StandardDigits(int digit) {
		String result = "";
